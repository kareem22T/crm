...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(API_URL + '/api/Auth/register', { firstName, lastName, userName, email, password });
      if (response.status === 204) {
        console.error('No Content response from server.');
        return;
      }
  ...
  return (
    <>
      <div dir='rtl' className="flex p-4 d-flex justify-center align-center" style={{minHeight: "100vh", alignItems: "center"}}>
          ...
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                <span className="mb-1.5 block font-medium">سجل الان مجانا</span>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      ...
                      <span className="absolute right-4 top-4" style={{top: "50%", transform:" translateY(-50%)", right: 10}}>
